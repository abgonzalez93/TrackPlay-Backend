import { ForgotPasswordInput, ForgotPasswordSchema, LoginInput, LoginInputSchema } from '@trackplay/core/schemas'
...
export const authController = {
  ...
  login: async (req: Request, res: Response): Promise<void> => {
    const input = parseOrThrow<LoginInput>(LoginInputSchema, req.body)
  ...
  forgotPassword: async (req: Request, res: Response): Promise<void> => {
    const input = parseOrThrow<ForgotPasswordInput>(ForgotPasswordSchema, req.body)
